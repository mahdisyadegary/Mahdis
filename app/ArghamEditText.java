...
public class ArghamEditText extends android.support.v7.widget.AppCompatEditText {

    public ArghamEditText(Context context) {
        super(context);
    ...
    public ArghamEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        Typeface face=Typeface.createFromAsset(context.getAssets(), "fonts/IRANSansMobile(FaNum).ttf");
        this.setTypeface(face);
    }

    public ArghamEditText(Context context, AttributeSet attrs, int defStyle) {
