...
public class MahdisEditText extends EditText {

    public MahdisEditText(Context context) {
        super(context);
    ...
    public MahdisEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        Typeface face=Typeface.createFromAsset(context.getAssets(), "fonts/IRANSansMobile(FaNum).ttf");
        this.setTypeface(face);
    }

    public MahdisEditText(Context context, AttributeSet attrs, int defStyle) {
